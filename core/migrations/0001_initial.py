...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_sessiondata', (
        ...
        db.send_create_signal('core', ['SessionData'])
        ...
        db.create_table('core_listing', (
            ...
            ('zipcode', self.gf('django.db.models.fields.CharField')(max_length=5, db_index=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('core_sessiondata')
